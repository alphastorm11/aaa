    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_PlusOrMinus,SIGNAL(clicked()),this,SLOT(operations()));
    ...
    connect(ui->pushButton_percent_,SIGNAL(clicked()),this,SLOT(operations()));
    connect(ui->pushButton_Discharge,SIGNAL(clicked()),this,SLOT(operations()));
